...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderItemDto getOrderItemById(String email, Long orderId, Long itemId) {
        return getOrderByUserId(email, orderId)
                .getOrderItems()
                .stream()
    ...
    public List<OrderItemDto> findAllOrderItemsByOrderId(String email, Long orderId) {
        Order order = getOrderByUserId(email, orderId);
    ...
    private BigDecimal countTotal(ShoppingCart shoppingCart) {
        return BigDecimal.valueOf(shoppingCart.getCartItems()
                .stream()
    ...
    private Order getOrderByUserId(String email, Long orderId) {
        Optional<Order> optionalOrder = orderRepository
                .findByUserIdAndId(getUserByEmail(email).getId(), orderId);
